    ...
    return (
        <div className="flex flex-col items-center mx-56 gap-9 mt-16">
            <h1 className="font-bold text-4xl text-center text-gray-400 font-enrich">
                <span className="text-[#544ddd]">Create your dream portfolio effortlessly:</span> personalized portfolio and management tools at your fingertips for no cost.
            </h1>
            ...
            <button className="bg-[#dc658b] text-black rounded-xl p-3 font-semibold cursor-pointer" onClick={()=>router.push('/admin')}>
